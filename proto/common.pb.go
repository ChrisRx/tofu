...
func (*BytesValue) Descriptor() ([]byte, []int) { return fileDescriptorCommon, []int{0} }
...
func (*EmptyValue) Descriptor() ([]byte, []int) { return fileDescriptorCommon, []int{1} }
...
func init() { proto.RegisterFile("proto/common.proto", fileDescriptorCommon) }
